...
| `ImparaWatch/Views/SessionView.swift` | Kartenrunde: Vorderseite rollt nicht und wird durch Tippen oder Doppeltipp aufgedeckt, nicht durch die Krone; die Rückseite rollt und nimmt sich den Kronen-Fokus selbst, damit lange Karten ungekürzt dastehen und sich sofort durchblättern lassen; zwei Tasten bewerten, Always-On zeigt nur die Vorderseite |
